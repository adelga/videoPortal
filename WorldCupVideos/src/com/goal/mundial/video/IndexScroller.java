...
public class IndexScroller {
	...
	public final int ALING_RIGHT = 0;
	final public int ALING_LEFT = 1;

	public IndexScroller(Context context, ListView lv, int a) {
	...
	public void draw(Canvas canvas) {
		...
		canvas.drawRoundRect(mIndexbarRect, 5 * mDensity, 5 * mDensity,
				indexbarPaint);
//		Log.d(TAG,
//				mIndexbarRect.toString() + "  :.-.:  "
//						+ mIndexbarRect.toShortString());
	...
	public void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (aling == ALING_RIGHT) {
			...
			mIndexbarRect = new RectF(mIndexbarMargin ,
					mIndexbarMargin, mIndexbarMargin+ mIndexbarWidth, h - mIndexbarMargin);
	...
	/**
	 * @return the mListViewWidth
	 */
	public int getmListViewWidth() {
		return mListViewWidth;
	}

	/**
	 * @param mListViewWidth the mListViewWidth to set
	 */
	public void setmListViewWidth(int mListViewWidth) {
		this.mListViewWidth = mListViewWidth;
	}

	/**
	 * @return the mListViewHeight
	 */
	...
	/**
	 * @param mListViewHeight the mListViewHeight to set
	 */
